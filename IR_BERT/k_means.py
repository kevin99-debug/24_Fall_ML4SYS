...
cluster_centers_df.to_csv("kmeans_cluster_centers.csv", index=False)
...
scatter = plt.scatter(reduced_vectors[:, 0], reduced_vectors[:, 1], c=labels, cmap='plasma', s=10, alpha=0.6)
