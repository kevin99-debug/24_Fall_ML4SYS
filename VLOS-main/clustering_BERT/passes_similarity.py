...
def compute_similarity_matrix(pass_df):
    ...
    print(f"Computed cosine similarity matrix with shape {similarity_df.shape}")
...
def save_similarity_matrix(similarity_df, output_path):
    ...
    try:
        ...
        print(f"Failed to save similarity matrix to {output_path}: {e}")
...
def main():
    ...
    for folder in subfolders:
        ...
        try:
            ...
            print(f"Failed to compute or save average similarities: {e}")
